...
// Function to get average ratings for research materials (only for researchers)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'submit_review') {
    ...
    try {
        ...
        switch ($materialType) {
            ...
            case 'research':
                if ($userRole != 10) {
                    throw new Exception("Unauthorized access to research materials");
                }
...
$researchMaterials = $isResearcher ? getResearchMaterialRatings($pdo) : [];
    ...
    <div class="flex-grow-1">
        ...
        <div class="container mt-4">
            ...
            <div class="tab-content" id="materialTabsContent">
                ...
                <?php if ($isResearcher): ?>
                <!-- Research Materials Tab (Only visible to researchers) -->
